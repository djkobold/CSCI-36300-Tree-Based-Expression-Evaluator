...
#ifndef _CS363_PRINT_POST_EXPR_H_
#define _CS363_PRINT_POST_EXPR_H_

#include "Expr_Node_Visitor.h"
#include <string>
#include <exception>

class Print_Postorder_Expression : public Expr_Node_Visitor
{
public:
	///Default Constructor
	Print_Postorder_Expression (void);
	
	///Destructor
	virtual ~Print_Postorder_Expression (void);
...
#include "Print_Postorder_Expression.cpp"

#endif // !defined _CS363_PRINT_POST_EXPR_H_
